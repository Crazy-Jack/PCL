...
python3 /home/tianqinl/PCL/main_pcl.py /work/tianqinl/CUB_200_2011/ \
-a resnet50 \
--lr 0.03 \
...
--exp-dir "/results/tianqinl/train_related/PCL/CUB/num_cluster_$num_cluster+$batch_size+moco-m0.8" \
--moco-m 0.8 \
--dataset CUB \
