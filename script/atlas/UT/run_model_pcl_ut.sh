...
python3 /home/tianqinl/PCL/main_pcl.py /work/tianqinl/ut-zap50K-processed \
-a resnet50 \
--lr 0.03 \
...
--exp-dir "/results/tianqinl/train_related/PCL/UT-zappos/num_cluster_$num_cluster+$batch_size+moco-m0.999" \
--moco-m 0.999 \
--dataset UT-zappos \
