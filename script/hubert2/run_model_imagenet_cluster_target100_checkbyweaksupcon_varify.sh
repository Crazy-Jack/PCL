...
--exp-dir /data/yaohungt/ILSVRC/Results_imagenet/target_100/moco_cluster_corrected_by_weaksupcon/gran_level_$1/bz_$bz_num_cluster_$2_lr0.03_$2_trail_$trail \
--warmup-epoch 10 \
--data-root train_100 \
--save-epoch 25 \
