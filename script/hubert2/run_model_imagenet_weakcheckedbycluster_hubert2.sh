...
CUDA_VISIBLE_DEVICES=$3 python3 ~/PCL/main_moco_weak_checkbycluster.py /data/yaohungt/ILSVRC/Data/CLS-LOC \
-a resnet50 \
--lr 0.4 \
--batch-size $bz \
--temperature 0.2 \
...
--exp-dir /data/yaohungt/ILSVRC/Results_imagenet/imagenet_all/moco_weakcon_correctbyclustering/gran_$1/bz_$bz_num_cluster_$2 \
--warmup-epoch 10 \
--data-root train \
--save-epoch 5 \
